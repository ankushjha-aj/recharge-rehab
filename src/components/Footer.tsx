...
const Footer: React.FC = () => {
  return (
    <>
      ...
      <div className="h-20 md:h-32 w-full flex-shrink-0" />

      {/* Subtle top divider line */}
      <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-primary/25 to-transparent mb-12" />
